...
import 'package:hotel_finde_hotel/feature/home/screen/room_details.dart';
import 'package:hotel_finde_hotel/feature/main/screen/main_bottom_app_bar_screen.dart';
import 'package:hotel_finde_hotel/feature/map/map.dart';
...
abstract class RouteNamedScreens {
  static String init =
      AppSharedPreferences.getUserId().isEmpty ? register : bottomAppBar;
  ...
  static Route? onGenerateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      case RouteNamedScreens.map:
        return FadeBuilderRoute(page: Map());
